...
from augus.HilosGraficar import Graficar3D, GraficarGramatica
...
class Optimizacion(threading.Thread):
    ...
    def analizar(self):
            ...
            gramaticales = GramaticaA.lstGrmaticales
            gg = GraficarGramatica(args=(gramaticales,"gramatical"), daemon= True)
            gg.start()
